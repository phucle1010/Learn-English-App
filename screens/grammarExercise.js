import { StyleSheet, Text, SafeAreaView, View, Pressable, FlatList, Dimensions, ToastAndroid, TouchableOpacity, Modal } from "react-native";
        ...
        <SafeAreaView style={{ flex: 1 }}>
            {!isStart
                ...
                : <View style={{ flex: 1, paddingHorizontal: 22, backgroundColor: '#fff' }}>
                    ...
                    >
                        <View style={{ borderWidth: 1, borderColor: '#BEBEBE', width: '100%', justifyContent: 'center', alignItems: 'center', height: 82, borderRadius: 20 }}>
