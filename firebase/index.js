...
import { getFirestore, doc, getDoc, getDocs, deleteDoc, collection, query, where, orderBy, addDoc } from 'firebase/firestore';
...
export default db;
export { auth, doc, getDoc, getDocs, collection, deleteDoc, query, where, orderBy, addDoc };
